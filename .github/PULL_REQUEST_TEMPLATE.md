...
- [ ] New applet
- [ ] New flag on an existing applet
- [ ] Breaking change (behavior / exit code / output format change)
...
- [ ] `python -m pytest -q` passes (402/402)
...
- [ ] Verified on Linux
- [ ] Verified on Windows
- [ ] Verified on macOS (or not applicable)
